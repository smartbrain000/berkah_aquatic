                ...
                foreach ($tampil as $t) {  ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-info" href="<?= base_url("Dashboard/update_beliperawatantanaman/" . $t['id_pl']) ?>"><i class="mdi mdi-lead-pencil"></i></a>
                            <a class="btn btn-danger" href="<?= base_url("Dashboard/del_beliperawatantanaman/" . $t['id_pl']) ?>"><i class="mdi mdi-delete" onclick="return confirm('Anda Yakin ?')"></i></a>
                        </td>
                    </tr>
                <?php $no++;
                } ?>
