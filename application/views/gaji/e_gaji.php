<div class="row">
    <div class="col-md-6">
        <div class="card">
            <form class="form-horizontal" method="POST" action="<?= base_url("Dashboard/update_gaji/" . $col['id_pl']) ?>">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="pl_nama" class="col-sm-4 text-left control-label col-form-label">Nama Karyawan</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="pl_total" class="col-sm-4 text-left control-label col-form-label">Gaji Karyawan</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="pl_total" id="pl_total" value="<?= $col['pl_total'] ?>" placeholder="">
