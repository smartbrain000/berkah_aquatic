<div class="row">
    <div class="col-md-6">
        <div class="card">
            <form class="form-horizontal" method="POST" action="<?= base_url("Dashboard/update_maintenance/" . $col['id_pl']) ?>">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="pl_total" id="pl_total" value="<?= $col['pl_total'] ?>" placeholder="Biaya Pengeluaran">
