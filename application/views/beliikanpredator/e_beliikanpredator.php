<div class="row">
    <div class="col-md-6">
        <div class="card">
            <form class="form-horizontal" method="POST" action="<?= base_url("Dashboard/update_beliikanpredator/" . $col['id_pl']) ?>">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="pl_nama" class="col-sm-4 text-left control-label col-form-label">Nama Ikan</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="pl_harga" class="col-sm-4 text-left control-label col-form-label">Harga Ikan</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="pl_jumlah" class="col-sm-4 text-left control-label col-form-label">Jumlah Ikan</label>
                        <div class="col-sm-8">
